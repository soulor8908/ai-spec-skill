...
`;
// ============ apps/web 渲染 ============
export function renderAppsWeb(opts, warnings) {
    const writes = [];
    if (opts.stack.frontend !== 'react-vite') {
        // experimental 前端防护：显式警告 + 写入说明文件（不再静默 fallback）
        warnings.push(`frontend="${opts.stack.frontend}" 为 experimental，未生成 React 骨架（experimental 适配器防护，建议 1）`);
        writes.push({
...
//# sourceMappingURL=web-scaffold.js.map