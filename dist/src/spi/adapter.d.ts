...
export interface RenderArchitectureSpi {
    renderArchitecture(input: RenderArchitectureInput): Promise<{
        writes: WriteOp[];
    }>;
}
/**
...
export interface GenerateCiConfigSpi {
    generateCiConfig(input: GenerateCiConfigInput): Promise<{
        writes: WriteOp[];
    }>;
}
...
export interface RenderRolePromptsSpi {
    renderRolePrompts(input: RenderRolePromptsInput): Promise<{
        writes: WriteOp[];
    }>;
}
/**
